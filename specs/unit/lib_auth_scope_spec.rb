...
describe 'Test AuthScope' do # rubocop:disable BlockLength
  ...
  it 'HAPPY AUTHENTICATION SCOPE: should validate default full scope' do
    scope = AuthScope.new
  ...
  it 'HAPPY AUTHENTICATION SCOPE: should evalutate read-only scope' do
  ...
  it 'HAPPY AUTHENTICATION SCOPE: should validate single limited scope' do
  ...
  it 'HAPPY AUTHENTICATION SCOPE: should validate list of limited scopes' do
